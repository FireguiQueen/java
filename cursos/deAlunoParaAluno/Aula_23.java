...
public class Aula_23 {
    public static void main(String[] args) {
        ...
        /*
            ...
            No 'while', primeiro é analisada a condição. Se ela for true, execute o bloco. Se for false,
            não execute.
        */
        ...
        // independentemente da condição ser false ou verdadeira.
        ...
        */
        ...
        /*
            Imagine um programa bem simples que utiliza o terminal.
            A ideia é o usuário digitar um número positivo e será retornado se o número é ímpar ou par.
            Para isso, precisamos utilizar a classe "Scanner" do Java.

            Detalhe, queremos APENAS números POSITIVOS, então, podemos montar o seguinte algoritmo:
            ...
            Caso ele digite um número positivo, terminaremos este laço de repetição, pois X será maior do que zero.
        */
    }
}

...
/*
    ...
    Resumidamente, é um valor inteiro em segundos ou milisegundos que representa o
    tempo passado desde jan 01, 1970 até hoje.
*/ 

public class Aula_15{
    public static void main(String[] args)
    {
        // Em java, podemos pegar esses milisegundos através do método "currentTimeMillis()".
